 ...
 */
	...
	Router::connect('/salon', array('controller' => 'salon', 'action' => 'index'));
	Router::connect('/product/:slug', array('controller' => 'products', 'action' => 'view'), array('pass' => array('slug')));
	
	//Router::connect('/salon/:id', array('controller' => 'salon', 'action' => 'storeinformation'), array('pass' => array('id')));
	...
	Router::connect('/staticpage/:id', array('controller' => 'staticpages', 'action' => 'view'), array('pass' => array('id')));
	...
	Router::connect('/bussinesslist/*', array('controller' => 'salon', 'action' => 'bussinesslist'));
	Router::connect('/:page', array('controller' => 'pages', 'action' => 'view'), array('pass' => array('page')));
